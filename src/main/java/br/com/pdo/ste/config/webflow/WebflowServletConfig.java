package br.com.pdo.ste.config.webflow;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "br.com.produtec.ste.app", scopedProxy = ScopedProxyMode.TARGET_CLASS, useDefaultFilters = false, includeFilters = {
